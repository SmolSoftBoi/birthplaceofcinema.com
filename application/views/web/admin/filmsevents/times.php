		...
		<table class="table table-striped table-hover">
			...
			<?php foreach ($filmevent_times as $filmevent_time_item) { ?>
				<tr>
					...
					<td>
						<a class="btn btn-xs btn-default" href="<?php echo base_url('admin/filmsevents/edittime/' . $filmevent_item['filmevent_id'] . '/' . $filmevent_time_item['filmevent_time_id']); ?>">Edit</a>
						<a class="btn btn-xs btn-danger" href="<?php echo base_url('admin/filmsevents/deletetime/' . $filmevent_item['filmevent_id'] . '/' . $filmevent_time_item['filmevent_time_id']); ?>">Delete</a>
					</td>
				</tr>
			<?php } ?>
			</tbody>

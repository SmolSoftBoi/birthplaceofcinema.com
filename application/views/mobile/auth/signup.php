...
<div class="signin">
	...
	?>
		...
		<input type="text" id="user" name="user" placeholder="Email" value="<?php echo set_value('username'); ?>" required>
...
<div class="signup">
	...
	?>
		...
		<input type="text" id="first_name" name="first_name" placeholder="First Name" value="<?php echo set_value('first_name'); ?>" required autofocus>
